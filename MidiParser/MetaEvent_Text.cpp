...
void MetaEvent_Text::Read_impl()
{
	...
	case 0x02:	ReadText("Copyright notice:\n");	break;
...
void MetaEvent_Text::ReadText(const char* eventMsg)
{
	...
	if (length > 0xFF) WARNING("Max 256 bytes and ISO-8859-1 character set allowed");
	...
	else if (strcmp(eventMsg, "Text event") == 0 || strcmp(eventMsg, "Marker text") == 0)
